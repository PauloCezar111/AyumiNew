...
const banner2 = cfonts.render((`» Yunyun Bot V1«\n@lukasz_`), {
font: 'console',
align: 'center',
gradient: ['cyan', 'blue']
});
...
module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, banner2, temporizador, color, recognize, bgcolor, isFiltered, addFilter, banner3, chyt, getExtension, convertSticker, upload, nit, getpc, supre, MercadoPagoKey}
