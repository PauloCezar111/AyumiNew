...
const MercadoPagoKey = `APP_USR-1456616216806070-071419-c9dec93a0dab9747dec2b4963beb1115-1424270910`
...
fs.writeFileSync('./lib/sticker/data.exif', Buffer.concat([_, __, ___, ____]), function (err) {
console.log(err)
if (err) return console.error(err)
return `./lib/sticker/data.exif`
})
}
...
try {
opcoes ? opcoes : {}
const post = await axios({method: "get", url, headers: {
'user-agent': 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.128 Safari/537.36', 'DNT': 1, 'Upgrade-Insecure-Request': 1
...
authorname = 'New Megumin Bot'
packname = 'Lukas'

const chyt = "5561996697514@s.whatsapp.net";
const nit = "556196697514@s.whatsapp.net";
const supre = "5538984046597@s.whatsapp.net";
...
setTimeout(() => usedCommandRecently.delete(userId), 3000) 
}

module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, temporizador, color, recognize, bgcolor, isFiltered, addFilter, chyt, getExtension, convertSticker, upload, nit, getpc, supre, MercadoPagoKey}
